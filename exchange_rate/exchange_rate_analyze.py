...
class ExchangeRateAnalyzer:
    ...
    def visualize_data(self):
        ...
        plt.subplot(2, 1, 1)
        plt.plot(self.df['Date'], self.df['Exchange Rate'], marker='o', linestyle='-', color='b', label='Exchange Rate')
        plt.plot(self.df['Date'], self.df['Moving Average'], linestyle='--', color='r', label=f'{self.moving_average}-day Moving Average')
